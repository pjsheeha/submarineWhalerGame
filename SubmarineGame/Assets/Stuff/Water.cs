...
public class Water : MonoBehaviour {
    ...
    //All our constants
    const float springconstant = 0.02f*2;
    const float damping = 0.04f*2.5f;
    const float spread = 0.05f*2;
    const float z = -1f;
    ...
    public void Splash2(Vector3 pos, float velocity)
    {
        //If the position is within the bounds of the water:
            ...
            GameObject splish = Instantiate(splash2, position, rotation) as GameObject;
    ...
    public void SpawnWater(float Left, float Width, float Top, float Bottom)
    {
        ...
        for (int i = 0; i < edgecount; i++)
        {
            ...
            meshobjects[i] = Instantiate(watermesh,new Vector3(0,0,5),Quaternion.identity) as GameObject;
